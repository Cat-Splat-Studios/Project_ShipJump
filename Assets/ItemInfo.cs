...
public class ItemInfo : MonoBehaviour
{
    ...
    {
        if(GearManager.CheckGears(price) && !isUnlocked)
        {
    ...
    public void ButtonAction()
    {
        ...
        else
        {
            ...
            confirmPurchase.SetReference(this, price);
    ...
    {
        if (GearManager.CheckGears(price))
        {
            SwapManager.PurchaseAsset(unlockIndex, itemtype);
            isUnlocked = true;
            parentShop.InitItems();
        }
    }
